...
$(function(){
  ...
  if(urlParts.length >= 6) {
  	if(urlParts[4]=="create") {
  		$('#'+urlParts[5]).attr("selected",true);
  	}
  }
  ...
  $(".submit-btn").click(function() {
  	if(checkICMail($("#mailForm").val())){
  		if($("#nameForm").val() &&
  		   ...
  		   $("#serviceForm").val() &&
  		   $("#descriptionForm").val()) {
  			$.post("http://clayish-airfields.000webhostapp.com/contact.php", //TODO: insert link to contact script
  			{
   				name: $("#nameForm").val(),
   				mail: $("#mailForm").val(),
  ...
  $(".btn-newsletter").click(function() {
  	if(checkICMail($("#inputNewsletter").val())){
  		$.post("http://clayish-airfields.000webhostapp.com/newsletter.php", //TODO: insert link to newsletter script
  		{
